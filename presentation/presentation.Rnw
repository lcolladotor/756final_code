...
\begin{itemize}
	...
	\item 890 pairs, 41.34831\% with both regions having a width greater than 1
...
\begin{itemize}
\item Project code and results: \url{https://github.com/lcolladotor/756final_code}
...
\item \textbf{derfinder} package \url{https://github.com/lcolladotor/derfinder}
\end{itemize}
