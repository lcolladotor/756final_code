...
<div class="message"><pre class="knitr r">## 2013-12-14 18:27:03 running GEE with AR1
</pre></div>
<div class="source"><pre class="knitr r">geeInd <- mclapply(idx, myGEE, corstr="exchangeable", mc.cores=20)
...
<div class="chunk" id="reproducibility1"><div class="rcode"><div class="output"><pre class="knitr r">## [1] "2013-12-14 18:27:41 EST"
</pre></div>
</div></div>
...
<div class="chunk" id="reproducibility2"><div class="rcode"><div class="output"><pre class="knitr r">## Time difference of 37.7 secs
</pre></div>
</div></div>
