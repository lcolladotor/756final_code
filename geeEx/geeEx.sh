...
## Usage:
# sh geeEx.sh PROJECTDIR RUNDIR CHRNUM RESULTSDIR
## Example:
# sh geeEx.sh derHippo geeEx 22 /home/bst/student/lcollado/756final_code/results
...
# merge results
Rscript geeEx.R -p '${PROJECTDIR}' -d '${RESULTSDIR}' -c '${CHRNUM}' -r '${RUNDIR}' -v TRUE
